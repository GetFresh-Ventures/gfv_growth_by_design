...
clear
echo "╔═══════════════════════════════════════════════════════════════════╗"
echo "║           Growth by Design™ CEO AI Kit                          ║"
echo "║           by GetFresh Ventures · getfreshventures.com            ║"
echo "╚═══════════════════════════════════════════════════════════════════╝"
echo ""
echo "  Stop adding headcount. Start engineering growth."
echo ""
echo "  This installs an AI Chief of Staff powered by the Growth by"
echo "  Design™ methodology — the same approach that has impacted"
echo "  \$500M+ in client revenue across 50+ companies."
echo ""
...
echo "  │  GROW WITH US                                                │"
echo "  │                                                              │"
echo "  │  📰  Growth by Design™ Newsletter (free):                    │"
echo "  │      https://growthbydesign.substack.com                     │"
echo "  │                                                              │"
echo "  │  🔍  Take the free Growth Diagnostic (5 min):                │"
echo "  │      https://www.getfreshventures.com/diagnostic             │"
echo "  │                                                              │"
echo "  │  🤝  Need expert deployment? Book a discovery call:          │"
echo "  │      https://www.getfreshventures.com/contact                │"
echo "  └──────────────────────────────────────────────────────────────┘"
echo ""
